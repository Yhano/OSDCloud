...
start /wait %windir%\system32\WindowsPowerShell\v1.0\powershell.exe -NoL -ExecutionPolicy Bypass -File C:\Windows\Setup\Scripts\Rename.ps1 >> C:\Windows\Setup\Scripts\Rename.log 2>&1
